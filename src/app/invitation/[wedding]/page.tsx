...
export async function generateMetadata({
  ...
  if (guestQueryParam) {
    ...
    if (guestObj) guestName = guestObj.name;
  }
  ...
  const description =
    ...
    (guestName
      ? `Undangan Pernikahan Spesial untuk ${guestName}. Buka dan lihat rangkaian acara kami.`
...
export default async function WeddingInvitationPage({
  ...
  let guest = null;
  if (guestQueryParam) {
    const normalizedGuest = guestQueryParam.replace(/\s+/g, "-").toLowerCase();
