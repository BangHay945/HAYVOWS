          ...
          {events.map((evt, idx) => {
            ...
            return (
              <motion.div
                ...
                className="relative flex flex-col justify-between p-8 rounded-3xl bg-[#063c2f]/45 backdrop-blur-md border border-[#d4af37]/35 shadow-[0_8px_30px_rgba(0,0,0,0.5)] group hover:border-[#d4af37]/70 transition-all duration-300"
              >
                {/* Decorative Corners */}
                ...
                <div>
                  {/* Event Title Badge */}
                  <div className="inline-block py-1 px-4 rounded-full border border-[#d4af37]/40 bg-[#02241b] text-xs font-serif uppercase tracking-[0.25em] text-[#d4af37] mb-6">
                    {evt.title}
                  </div>

                  {/* Date & Time */}
                  <div className="space-y-3.5 mb-6 text-sm text-[#fdfbf7]">
                    <div className="flex items-start gap-3">
                      <Calendar className="w-4 h-4 text-[#d4af37] shrink-0 mt-0.5" />
                      <div>
                        <p className="font-semibold text-[#fdfbf7]">{dateFormatted}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        {evt.address && (
                          <p className="text-xs text-[#b8c9c1] mt-0.5 leading-relaxed font-light">
                            {evt.address}
                          </p>
                        )}
                      </div>
                ...
                <div className="pt-6 border-t border-[#d4af37]/20 flex flex-col sm:flex-row gap-3">
                  {mapLink && (
                    <a
                      ...
                      className="flex-1 inline-flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl border border-[#d4af37]/50 bg-[#02241b]/80 hover:bg-[#d4af37] hover:text-[#02241b] text-xs font-serif tracking-wider uppercase font-semibold text-[#d4af37] transition-all cursor-pointer shadow-sm"
                    >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 inline-flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl border border-[#d4af37]/30 bg-white/5 hover:bg-white/10 text-xs text-[#fdfbf7] tracking-wider transition-all cursor-pointer"
                  >
