...
async function main() {
    ...
    const tplNoir = await prisma.template.upsert({
        ...
        create: {
            slug: "eternal-noir",
            name: "Eternal Noir",
            description: "Tema pernikahan mewah premium bernuansa editorial hitam-putih dengan tipografi Cormorant Garamond, efek grayscale otomatis, hover reveal warna galeri, dot navigation sidebar, dan smooth full-page scroll sinematik.",
            isPremium: true,
            isActive: true,
            version: "1.0.0",
        },
    ...
    const tplBatikJawa = await prisma.template.upsert({
        ...
        create: {
            ...
            description: "Tema pernikahan adat Jawa Kraton dengan ornamen gunungan & kawung SVG, tipografi prasasti, palet merah saga & emas kraton, serta alunan gamelan Jawa.",
            isPremium: true,
            isActive: true,
            version: "1.0.0",
        },
    ...
    const tplRoyalEmerald = await prisma.template.upsert({
        ...
        create: {
            ...
            description: "Kemewahan aristokrat bernuansa hijau zamrud (emerald velvet) dipadukan dengan aksen emas bangsawan, ornamen mahkota kerajaan, dan tata letak split desktop sinematik.",
            isPremium: true,
            isActive: true,
            version: "1.0.0",
        },
        ...
        create: {
            ...
            couple: {
                create: {
                    ...
                    groomPhoto: "/assets/templates/pixel-cyberpunk/characters/portraits/portrait-groom.png",
                    brideName: "Elara Chen, S.Ds.",
                    brideNickname: "Elara",
                    brideFather: "Bpk. Marcus Chen",
                    brideMother: "Ibu Meilani Chen",
                    brideInstagram: "elara_chen",
                    bridePhoto: "/assets/templates/pixel-cyberpunk/characters/portraits/portrait-bride.png",
                },
            },
            events: {
                create: [
            ...
            galleries: {
                create: [
                    {
                        imageUrl: "/assets/templates/pixel-cyberpunk/characters/portraits/portrait-groom.png",
                        caption: "Groom Liam",
                        sortOrder: 1,
                    },
                    {
                        imageUrl: "/assets/templates/pixel-cyberpunk/characters/portraits/portrait-bride.png",
                        caption: "Bride Elara",
                        sortOrder: 2,
                    },
                    {
                        imageUrl: "/assets/templates/pixel-cyberpunk/maps/skyline-district-v1/ground-map.png",
        ...
        data: [
            {
                ...
                message: "Selamat atas pernikahan Xavier & Eleanor yang begitu elegan dan istimewa. Semoga cinta abadi kalian senantiasa bercahaya.",
                status: "approved",
                isPinned: true,
            },
        ],
        ...
        data: [
            {
                ...
                message: "Nderek mangayubagya dumateng Mas Prasetyo & Mbak Kinanti. Mugi tansah pinaringan berkah dalem Gusti, ayem tentrem, lan langgeng dumugi kaken-kaken ninen-ninen.",
                status: "approved",
                isPinned: true,
            },
        ],
